...
#define MEEPLEOUTLINEHIGHLIGHTCOLOR1 sf::Color::Color(205,188,21,255)
#define MEEPLEOUTLINECOLOR2 sf::Color::Color(0,37,250,255)
#define MEEPLEOUTLINEHIGHLIGHTCOLOR2 sf::Color::Color(0,27,200,255)
#define MEEPLEOUTLINECOLOR3 sf::Color::Color(209,7,0,255)
#define MEEPLEOUTLINEHIGHLIGHTCOLOR3 sf::Color::Color(179,5,0,255)
#define MEEPLEOUTLINECOLOR4 sf::Color::Color(23,128,0,255)
#define MEEPLEOUTLINEHIGHLIGHTCOLOR4 sf::Color::Color(17,100,0,255)
